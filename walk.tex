...
Let $s\geq 1$.
Denote a spanning path in $Q_{\infty}$ by $u_1\cdots u_{2s}$. 
...
%Then by Lemma \ref{addtec}, we deduce the $k$-walk from the assumption that $G$ is $(\frac{1}{k-1}+\epsilon)$-tough.
\qed
