...
ending at $u_{2\sigma}\in V(F)$r. %, with all the edges in $S$ in the path.
...
adjacent to $u_4$. As $u_1u_2$ wealky dominates $u_4u_5$, we have $u_2$ must be 
adjacent to $u_5$. 
...
$\Pi_4\Pi_1\overline{\Pi_2}\Pi_0$, where $\overline{\Pi_2}$
