...
unlike \cite{broersma2014toughness}, we cannot 
make unconditional algorithmic conclusions about the problem at hand.
...
A {\em blow-up} in $G$ is the procedure of replacing $v\in V(G)$ 
...
\item $G$ can be obtained from the 5-gon by repeated blow-ups. \qed
\end{enumerate}
\end{lemma}
